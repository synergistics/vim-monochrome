...
hi CursorLine guifg=LightGray guibg=#202020 ctermbg=18 gui=NONE cterm=NONE term=NONE
...
hi VertSplit ctermfg=18 ctermbg=0
...
hi StatusLine guifg=LightGray ctermfg=20 guibg=#202020 ctermbg=18 gui=NONE cterm=bold term=NONE
hi StatusLineNC guifg=LightGray ctermfg=20 guibg=#181818 ctermbg=19 gui=NONE cterm=NONE term=NONE
...
hi MatchParen guifg=Black ctermfg=16 guibg=LightGray ctermbg=19 gui=NONE cterm=NONE term=NONE
...
hi Search guifg=White ctermfg=255 guibg=#778899 ctermbg=5 gui=NONE cterm=NONE term=NONE
hi Visual guifg=White guibg=#778899 ctermbg=19 gui=NONE cterm=NONE term=NONE
